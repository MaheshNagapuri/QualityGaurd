"""
Data cleaning for defect classifier training dataset.
...
# TODO: Implement clean_defect_classifier_dataset() function
# Purpose: Clean raw defect classifier training data by removing noise, duplicates, outliers, and invalid values
...
# Clean defect-training data by removing nulls/duplicates, enforcing bounds, filtering countries, and trimming IQR outliers.
def clean_defect_classifier_dataset(input_file):
